BEGIN
   FOR i IN (SELECT table_name FROM user_tables WHERE table_name IN ('TRADE', 'ORDER_TABLE', 'PRICE', 'INSTRUMENTHISTORYPRICE', 'INSTRUMENT', 'INVESTMENTPREFERENCE', 'CLIENTIDENTIFICATION', 'CLIENT', 'PORTFOLIO'))
   LOOP
